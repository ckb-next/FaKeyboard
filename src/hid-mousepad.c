...
const USB_DEVICE_DESCRIPTOR dev_dsc =
{
    ...
    0x1b1c,                 // Vendor ID
    0x1b3b,                 // Product ID: Mouse in a circle fw demo
...
const CONFIG_HID_MOUSEPAD  configuration_hid = {{
    ...
    // IF 2
    {
        ...
        0x01,         // Number of class descriptors, see usbcfg.h
        0x22,                // Report descriptor type
        0x0018,           // Size of the report descriptor
    }, {
        /* Endpoint Descriptor */
        0x07,/*sizeof(USB_EP_DSC)*/
        USB_DESCRIPTOR_ENDPOINT,    //Endpoint Descriptor
...
{
  0x06, 0xc2, 0xff, 0x09, 0x01, 0xa1, 0x01, 0x15, 0x00, 0x26, 0xff, 0x00, 0x75, 0x08, 0x95, 0x40,
  0x09, 0x01, 0x81, 0x02, 0x95, 0x40, 0x09, 0x01, 0x91, 0x02, 0x95, 0x40, 0x09, 0x01, 0xb1, 0x02,
  0xc0
};

const byte corsair_report2[24] =
{
    0x05, 0x01, 0x09, 0x06, 0xa1, 0x01, 0x05, 0x07, 0x19, 0x00, 0x29, 0x97, 0x15, 0x00, 0x26, 0x97,
